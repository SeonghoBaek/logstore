 ...
 */
public class InfoLogReport implements IReport {
    private long C = 0;
    private long D = 0;
    private long E = 0;
    ...
    public String getJSONString() {
        ...
        String jsonReport = String.format(ReportSchema.EWMALogReportPrefix, LogLevel.INFO, this.interval, c, d, e);

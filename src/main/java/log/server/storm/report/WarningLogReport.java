 ...
 */
public class WarningLogReport implements IReport {
    private long C = 0;
    private long D = 0;
    private long E = 0;
    private long interval = 0;

    private LogList Summary = null;

    public WarningLogReport() {
        Summary = new LogList();
    }
    ...
    public String getJSONString() {
        ...
        String jsonReport = String.format(ReportSchema.EWMALogReportPrefix, LogLevel.WARNING, this.interval, c, d, e);
